...
//        RoundedImageView logoImage = (RoundedImageView)findViewById(R.id.logoImage);
    ...
    private void setupTabIcons() {
        tabLayout.getTabAt(0).setIcon(R.drawable.doc);
        tabLayout.getTabAt(1).setIcon(R.drawable.doc);
        tabLayout.getTabAt(2).setIcon(R.drawable.doc);
        tabLayout.getTabAt(3).setIcon(R.drawable.doc);
        tabLayout.getTabAt(4).setIcon(R.drawable.doc);
    }
    ...
    public class SampleFragmentPagerAdapter extends FragmentPagerAdapter {
        ...
        private int tabIcons[] = {R.drawable.doc, R.drawable.doc, R.drawable.doc, R.drawable.doc, R.drawable.doc};
