...
public class QuestionAdapter extends RecyclerView.Adapter<QuestionAdapter.MyAddHolder>{
    ...
    public void onBindViewHolder(MyAddHolder holder, int position) {
        ...
        holder.subject.setText("Sub : "+arrayList.get(position).getSubject());
        holder.desc.setText("Details : "+arrayList.get(position).getDescription());
        holder.name.setText("Doc : "+arrayList.get(position).getDoctorName());
