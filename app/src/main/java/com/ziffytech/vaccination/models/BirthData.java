...
public class BirthData {
    ...
    @SerializedName("us_salutations")
    @Expose
    private String usSalutations;
    ...
    public String getUsSalutations() {
        return usSalutations;
    }

    public void setUsSalutations(String usSalutations) {
        this.usSalutations = usSalutations;
    }
